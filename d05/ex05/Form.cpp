...
void			Form::canExec(Bureaucrat const &exec) const
{
	if (!this->getSigned())
		throw Form::ExecUnsignedException();
	if (exec.getGrade() > this->_execGradeRequired)
		throw Form::GradeTooLowException();
}
...
Form::ExecUnsignedException::ExecUnsignedException() throw() {}

char const					*Form::ExecUnsignedException::what() const throw() { return "Form: Unsigned"; }
